    ...
    <div :class="['justifyCenter']">
      <table :class="['table']">
        ...
        >
          ...
          <td :class="['textRight']">${{ record.principalRemaining.toFixed(2) }}</td>
        </tr>
        <tr>
          <td :class="['textLeft']"><b>Totals:</b></td>
          <td :class="['textRight']"><b>${{ this.paymentSummary.totalPrincipalPaid.toFixed(2) }}</b></td>
          <td :class="['textRight']"><b>${{ this.paymentSummary.totalInterestPaid.toFixed(2) }}</b></td>
